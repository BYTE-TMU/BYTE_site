  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 sm:bottom-6 sm:right-6">
      <div className="relative">
        <div
          className={`chat-panel absolute bottom-16 right-0 flex h-[70vh] w-[calc(100vw_-_2rem)] flex-col border border-[#222222] bg-black shadow-2xl sm:h-[28rem] sm:w-80 ${
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="border-t border-[#222222] p-3">
            <div className="flex gap-2">
              ...
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 12 3.269 3.126A59.77 59.77 0 0 1 21.485 12 59.77 59.77 0 0 1 3.27 20.876L5.999 12Zm0 0h7.5" />
                </svg>
              </button>
            </div>
          </form>
