      ...
      >
        ...
        <div className="flex items-center justify-center gap-6 sm:justify-self-center">
          <a
            ...
            className="text-muted transition-all duration-200 hover:text-white hover:scale-110"
          >
          ...
          <a
            href="https://discord.gg/YYkkEtrgUm"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Discord"
            className="text-muted transition-all duration-200 hover:text-white hover:scale-110"
          ...
          >
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 24H8.485V15.03L1.783 21.732 0 19.949 6.723 13.223H0v-3.34h6.723L0 6.157l1.783-1.783 6.702 6.702V.505h3.514v10.594l6.702-6.702 1.783 1.783-6.723 6.723H24v3.34h-6.723l6.723 6.723-1.783 1.783-6.702-6.702V24z" />
            </svg>
          </a>
        </div>
