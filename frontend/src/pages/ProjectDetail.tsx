...
export default function ProjectDetail() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 pt-40 pb-24">
      <Link
        to="/projects"
        className="mb-8 inline-block font-mono text-xs tracking-widest text-muted uppercase transition-colors hover:text-white"
      >
        ← Back to Projects
      </Link>
      ...
      <h1 className="text-5xl font-black tracking-tight md:text-7xl">{project.name}</h1>
