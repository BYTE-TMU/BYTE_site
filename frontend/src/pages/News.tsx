  ...
  return (
    <main className="mx-auto max-w-7xl px-6 pt-40 pb-24">
      <Reveal className="mb-12">
        <p className="neon-green-text mb-2 font-mono text-sm tracking-widest uppercase">Latest</p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {announcements.map((announcement, i) => (
          <Reveal key={announcement.id} className="h-full" threshold={0.1} delayMs={(i % COLUMNS) * 150}>
            <article
